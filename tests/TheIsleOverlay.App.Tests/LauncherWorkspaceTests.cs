...
public sealed class LauncherWorkspaceTests
{
    ...
    [Fact]
    public void Home_ContainsTeamAndUndoProActivationWithoutUpstreamContactBranding()
    {
        ...
        Assert.DoesNotContain("https://isle.klong.dev", code, StringComparison.Ordinal);
        Assert.DoesNotContain("ZaloTeamQr.jpg", code, StringComparison.Ordinal);
    }
