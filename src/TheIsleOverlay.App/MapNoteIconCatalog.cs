...
public static class MapNoteIconCatalog
{
    ...
    [
        ...
        new(MapNoteKind.Pin, "Mốc thường", "#AF4EE7", "M10,0 C4.5,0 1,4 1,9 C1,15 10,21 10,21 C10,21 19,15 19,9 C19,4 15.5,0 10,0 Z M10,5 C7.8,5 6,6.8 6,9 C6,11.2 7.8,13 10,13 C12.2,13 14,11.2 14,9 C14,6.8 12.2,5 10,5 Z"),
        new(MapNoteKind.Rally, "Điểm tập hợp", "#3745D4", "M4,1 L6,1 L6,21 L4,21 Z M6,2 L18,5 L6,10 Z M1,21 L11,21 L11,23 L1,23 Z"),
        new(MapNoteKind.Water, "Nguồn nước", "#4B9BD4", "M10,0 C10,0 2,10 2,15 C2,20 5.6,23 10,23 C14.4,23 18,20 18,15 C18,10 10,0 10,0 Z"),
        new(MapNoteKind.Meat, "Thức ăn ăn thịt", "#804DD8", "M6,5 C3,2 0,4 2,7 L7,12 C9,14 12,14 14,12 L18,8 C21,5 18,1 15,3 L11,6 C9,8 8,7 6,5 Z M3,14 L6,17 L3,20 C1,22 -1,19 1,17 Z"),
        new(MapNoteKind.Plant, "Thức ăn ăn cỏ", "#6BC6AE", "M19,1 C10,1 3,5 3,12 C3,16 6,19 10,19 C16,19 20,12 19,1 Z M3,22 C7,14 11,10 17,5"),
        new(MapNoteKind.Nest, "Vị trí tổ", "#D6A9E8", "M1,15 C5,19 15,19 20,15 L18,20 C13,23 7,23 3,20 Z M6,12 C6,6 8,2 11,2 C14,2 16,6 16,12 C13,14 9,14 6,12 Z"),
